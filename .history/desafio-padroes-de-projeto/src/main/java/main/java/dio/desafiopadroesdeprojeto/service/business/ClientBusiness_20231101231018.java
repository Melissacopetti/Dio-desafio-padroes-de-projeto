    ...
    public String clientLogin(ClientLogin login) throws CustomError {
        try {
            ...
            if (password.length() < 8) {
                throw new InvalidRequest("Sua senha deve ter ao menos 8 dígitttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttto");
            }
