...
public class ClientController {
    ...
    public ResponseEntity<ResponseEntity<Clients>> createClient(@RequestBody ClientDTO newClient) {
        try {
            String token = clientBusiness.login(newClient.getEmail(), newClient.getPassword());
            ...
            HttpServletResponse response = WebUtils.getNativeResponse(RequestContextHolder.currentRequestAttributes().getResponse());
