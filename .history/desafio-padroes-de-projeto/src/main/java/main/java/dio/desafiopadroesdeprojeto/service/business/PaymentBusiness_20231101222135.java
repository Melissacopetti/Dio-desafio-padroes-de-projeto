...
java.
import java.dio.desafiopadroesdeprojeto.dataBase.*;
import java.dio.desafiopadroesdeprojeto.model.Clients.AuthenticationData;
import java.dio.desafiopadroesdeprojeto.customErrors.InvalidRequest;
import java.dio.desafiopadroesdeprojeto.model.payment.*;
import java.dio.desafiopadroesdeprojeto.model.domain.Payment;
import java.dio.desafiopadroesdeprojeto.service.TokenGenerator;
