...
public class PaymentBusiness {
    ...
    public Payment createPayment(Payment payment, String token) throws InvalidRequest {
        ...
        try {
            ...
            Payment newPayment = new Payment(Long.parseLong(id), Long.parseLong(authData.getId()), payment.getMethod(), payment.getAmount(), payment.getCardHolderName(), payment.getCardNumber(), payment.getCardExpDate(), payment.getCardCvv(), status);
