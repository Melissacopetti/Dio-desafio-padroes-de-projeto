...
}dio.desafiopadroesdeprojeto.customErrors.CustomError;
import dio.desafiopadroesdeprojeto.customErrors.InvalidRequest;
import dio.desafiopadroesdeprojeto.dataBase.ClientDataBase;
import dio.desafiopadroesdeprojeto.model.Clients.Client;
import dio.desafiopadroesdeprojeto.model.Clients.ClientDTO;
import dio.desafiopadroesdeprojeto.model.Clients.ClientLogin;
    ...
    public String createClient(ClientDTO client) throws CustomError {
        ...
        try {
            ...
            if (!cpfValidator.isValidCpf(cpf)) {
                throw new InvalidRequest("CPF inválido");
            }
