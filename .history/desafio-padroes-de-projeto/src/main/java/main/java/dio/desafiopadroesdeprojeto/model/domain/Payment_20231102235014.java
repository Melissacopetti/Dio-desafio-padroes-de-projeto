...
public class Payment {
    ...
    public Payment(Long id, PaymentMethod method2, double amount2, String cardHolderName2, String cardNumber2,
            String cardExpDate2, String cardCvv2, PaymentStatus analysis) {
    }
